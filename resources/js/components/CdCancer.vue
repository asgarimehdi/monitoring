<template>
    <div>
        ...
        <div class="container-fluid">
            ...
            <div class="row" v-if="$gate.isAdmin() ||$gate.isRiasat() || $gate.isBimaGVagir()">
                        ...
                        <div class="card-body small">
                            <div class="small ">
                                ...
                                <div class="card bg-info-gradient">
                                    ...
                                    <div class="row" v-for="type in cancer_type">
                                        <div class="col-8">
                                            {{type.name}}
                                        </div>
                                        <div class="col-4 p-0">
...
<l-popup class="vazir">
    ...
    <br>
            ...
            <!-- end is admin -->
            <div v-if="!($gate.isAdmin() ||$gate.isRiasat()|| $gate.isBimaGVagir())">
                <not-found></not-found>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadTemps() {
                ...
                axios.get("/api/cd/cancer/ListByCounty/" + this.user_county_id).then(({data}) => (this.markers = data)).then(() => {
            ...
            mapWatch(marker) {
                ...
                let y ;
                let z ;
                if (this.show_cancer[marker.type_id])
                {
