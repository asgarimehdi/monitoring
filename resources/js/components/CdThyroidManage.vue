                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover">
                            ...
                            <tr v-for="(thyroid , index) in thyroids.data" :key="index" class="small">

                                <td>{{thyroid.full_name}}</td>
                                ...
                                <td>
                                    ...
                                    {{thyroid.region_point.name}}
                                </td>


                                <td>
                                    <a href="#" @click="edit(thyroid)" >
                                        <i class="fa fa-edit blue"></i>
                                    </a>
                                    /
                                    <a href="#" @click="deleteValue(thyroid.id)">
                    ...
                    <div class="card-footer">
                        ...
                        <pagination :data="thyroids" size="small" :limit="8" @pagination-change-page="getResults"></pagination>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getResults(page = 1) {
                axios.get('api/cd/thyroid/PaginateByCounty?page=' + page)
                    .then(response => {
                        this.thyroids = response.data;
                    });
            },
            edit(value) {
                this.editmode = true;
            ...
            updateValue() {
                ...
                this.form.put('api/cd/thyroid/' + this.form.id)
                    .then(() => {
            ...
            deleteValue(id) {
                swal.fire({
                    ...
                    if (result.value) {
                        this.form.delete('/api/cd/thyroid/' + id).then(() => {
                            swal.fire(
                                'پاک شد',
                                'با موفقیت حذف شد',
                                'success'
            ...
            loadValues() {
                if (this.$gate.isAdminOrGroup_admin()) {
                    this.$Progress.start();
                    axios.get("api/cd/thyroid/PaginateByCounty").then(({data}) => (this.thyroids = data)).then(() => {
                        this.$Progress.finish();
                    }).catch(() => {
                        this.$Progress.fail();
                        toast.fire({
                            type: 'error',
                            title: 'خطایی در لود لیست تیروئید رخ داد'
                        });
                    });
                }
            },
        ...
        created() {
            ...
            Fire.$on('searching', () => {
                ...
                axios.get('api/cd/thyroid/findValue?q=' + query)
                    .then((data) => {
                        this.thyroids = data.data
                    })
                    .catch(() => {
