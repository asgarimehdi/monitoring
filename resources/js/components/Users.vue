<template>
  ...
  <div class="container">
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">
              <button type="button" class="btn btn-success"  @click="newModal" data-toggle="modal" data-target="#exampleModalCenter">
                ایجاد کاربر جدید
    ...
    <!-- Modal -->
    <div class="modal rtl fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNewLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="editmode ? updateUser() : createUser()">
            <div class="modal-body">
              ...
              <div class="input-group mb-3">
                <input v-model="form.password" type="password" placeholder="رمز عبور" name="password" id="password"
              ...
              <div class="input-group mb-3" v-if="(point_selected) || (!editmode)">
                ...
                <select name="county_id" v-model="form.county_id" id="county_id" class="form-control" ref="c"
                        :class="{ 'is-invalid': form.errors.has('county_id') }" @input="$emit('countySelected')">
                  <option
                          v-for="g in counties"
                          :value="g.id"
                  >
              ...
              <div class="input-group mb-3" v-if="county_selected">
                <select name="type_id" v-model="form.type_id" id="type_id" class="form-control"
                        :class="{ 'is-invalid': form.errors.has('type_id') }" @change="$emit('typeSelected')">
                  <option
                          v-for="g in types"
                          :value="g.id"
                  >
              ...
              <div class="input-group mb-3" v-if="type_selected">
                <select name="center_id" v-model="form.center_id" id="center_id" class="form-control"
                        :class="{ 'is-invalid': form.errors.has('center_id') }" @change="$emit('centerSelected')">
                  <option
                          v-for="g in centers"
                          :value="g.id"
                  >
              ...
              <div class="input-group mb-3" v-show="center_selected">
                ...
                <select name="point_id" v-model="form.point_id" id="point_id" class="form-control"
                        :class="{ 'is-invalid': form.errors.has('point_id') }" @change="$emit('pointSelected')">
                  <option
                          v-for="g in points"
                          :value="g.id"
                  >
