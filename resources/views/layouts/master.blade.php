...
<div class="wrapper" id="app">
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <form class="form-inline ml-3">
      <div class="input-group input-group-sm">
        <input class="form-control form-control-navbar" @keyup="searchit" v-model="search" type="search" placeholder="جستجو" aria-label="Search">
    ...
    <div class="sidebar">
      <div>
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">  کاربر جاری:
                {{Auth::user()->name}}
                <br/>
            <small>  نقش کاربر:
            {{Auth::user()->role->name}}</small></a>
            <small>  شهرستان کاربر:
            {{Auth::user()->region_point->region_center->region_county->name}}</small></a>
        </div>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                @canany(['isGroup_admin','isAdmin'])
                <li class="nav-item">
                  <a href="\coldchain" class="nav-link {{ (request()->is('coldchain')) ? 'active' : '' }}">
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="p-3">
      <h5> فضای خالی </h5>
      هنوز برای این قسمت ایده مناسبی ارائه نشده
      </div>
    </aside>
    <!-- /.control-sidebar -->
